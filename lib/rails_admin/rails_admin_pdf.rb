        ...
        register_instance_option :controller do
          Proc.new do
            ...
            Prawn::Document.new(PDF_OPTIONS) do |pdf|
              ...
              pdf.text "Link Para o Manual do Prawn<link href='http://prawnpdf.org/manual.pdf'> <color rgb='5ca3e6'>clicável</color></link>", :size => 10, :inline_format => true, :valign => :bottom, :align => :left
